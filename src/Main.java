...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        algorithmSelector.setValue("DFS");
                    ...
                    switch (currentMode) {
                        ...
                        case OBSTACLE:
                            if (cell.getFill() == Color.WHITE) {
                                ...
                                weights[finalI][finalJ] = Integer.MAX_VALUE;
        ...
        Button compareBtn = new Button("Compare Algorithms"); // New Button for Comparison
        ...
        HBox controls = new HBox(10, startBtn, endBtn, obstacleBtn, algorithmSelector, runBtn, compareBtn);
        ...
        primaryStage.setTitle("Pathfinding Visualizer (DFS, BFS, Dijkstra with Comparison)");
        primaryStage.show();
    }

    // ---------- Modified Search Methods with Operation Count -----------
    private int runBFS() {
    ...
    private void compareAlgorithms() {
        ...
        int bfsOps = runBFS();
        int dfsOps = runDFS();
        int dijkstraOps = runDijkstra();

        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Algorithm Comparison");
        alert.setHeaderText("Operation Counts:");
        alert.setContentText("BFS Operations: " + bfsOps + "\n" +
                "DFS Operations: " + dfsOps + "\n" +
                "Dijkstra Operations: " + dijkstraOps);
        alert.showAndWait();
    }
